  ...
  return (
    <header className="flex items-center justify-between px-3 h-11 bg-studio-panel border-b border-studio-border shrink-0 z-50 gap-2">
      ...
      <div className="flex items-center gap-2 min-w-0">
        ...
        <div className="relative group shrink-0">
          ...
          <div className="header-dropdown">
            ...
            <button onClick={saveProject} className="dropdown-item">
        ...
        <div className="relative group shrink-0">
          ...
          <div className="header-dropdown">
            <button onClick={undo} disabled={!canUndoVal} className="dropdown-item disabled:opacity-40">
              <kbd className="shortcut-key">⌘Z</kbd>
              <span>Undo {history[historyIndex]?.description}</span>
            </button>
            <button onClick={redo} disabled={!canRedoVal} className="dropdown-item disabled:opacity-40">
              <kbd className="shortcut-key">⇧⌘Z</kbd>
              <span>Redo</span>
            </button>
          </div>
        ...
        <input
          ...
          className="bg-transparent text-sm text-studio-text font-medium border-b border-transparent hover:border-studio-border focus:border-studio-accent/60 focus:outline-none px-1 py-0.5 w-32 md:w-44 transition-colors"
          spellCheck={false}
        />
      </div>
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        ...
        <span className="text-xs text-studio-subtle font-mono hidden lg:block">
        ...
        <div className="relative group">
          ...
          <div className="header-dropdown right-0 w-48">
            ...
            <div className="border-t border-studio-border my-1" />
            <button onClick={() => { handleExportHTML(); }} className="dropdown-item">
              <span className="text-studio-accent font-mono text-[10px] bg-studio-accent/10 px-1.5 py-0.5 rounded">PKG</span>
